  ...
  <HomePanel title="最新专题" ref="target">
    ...
    <template v-slot:default>
      <div class="special-list">
        <div class="special-item" v-for="item in PanelData" :key="item.id">
          <RouterLink to="/">
...
import { getBrandTheme } from "@/api/home";
export default {
  name: "HomeSpecial",
  components: { HomePanel },
  setup() {
    const { target, result: PanelData } = useLazyData(getBrandTheme);
    return { target, PanelData };
  },
};
</script>
